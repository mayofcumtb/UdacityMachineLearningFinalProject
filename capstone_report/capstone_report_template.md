...
- 需要解决的问题设计哪个领域?
-- 猫狗大战实际上是简化版的图像识别问题，图像识别是计算机视觉的核心内容，如果想描述清楚这个问题需要描述清楚什么是计算机视觉？什么是图像识别？什么是深度学习？
- 做这个项目的出发点？
-- 做这个项目的出发点最简单的就是了解深度学习对图像处理的影响，利用搭建复杂的深度学习矿建来解决复杂的图像处理问题
- 有哪些相关的数据集或输入数据？
- 最基本的数据集是MNIST，Kaggle， IMAGE NET 上面有很多现成的资料需要解释与参考。
<font color=orange>这个地方的要求就是浅显但是关键是了解自己的动机是什么。</font>
**问题的背景信息能够让没完全接触过这个问题的人充分了解这个问题吗？**
